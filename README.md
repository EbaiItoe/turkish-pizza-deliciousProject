...
**PIZZA-licious** is a command-line Point of Sale (POS) system for a pizza restaurant. It allows customers to build custom pizzas, select drinks, add sides, and generates itemized receipts. The application is built in Java using Maven.
